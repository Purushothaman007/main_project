...
STATIC_QUESTIONS: Dict[str, QuestionData] = {
    "two-sum": QuestionData(
        id="two-sum",
        title="Two Sum",
        difficulty="Easy",
        topic="Array / Hashing",
        short_description="Find two indices whose values add up to the target.",
        description=(
...
"""
    ...
    "reverse-linked-list": QuestionData(
        id="reverse-linked-list",
        title="Reverse Linked List",
        difficulty="Easy",
        topic="Linked List",
        short_description="Reverse a singly linked list and return its head.",
        description=(
...
"""
    ...
    "valid-parentheses": QuestionData(
        id="valid-parentheses",
        title="Valid Parentheses",
        difficulty="Easy",
        topic="Stack / String",
        short_description="Determine if the input string has valid open and closed brackets.",
        description=(
...
class QuestionService:
    def get_all_questions(self) -> List[QuestionData]:
        return list(STATIC_QUESTIONS.values())
